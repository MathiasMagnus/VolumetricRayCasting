...
function(__build_ir)
  ...
  foreach(targetSource ${targetSources})
	...
	#get_filename_component(SourceName ${targetSource} NAME)
	#if(SourceName MATCHES ui_)
	#  get_filename_component(SourceDir ${targetSource} DIRECTORY)
	#  list(APPEND device_compiler_includes ${SourceDir})
	#endif()
  endforeach()
